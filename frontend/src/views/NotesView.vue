<template>
  ...
  <div class="columns">
    <div class="column">
      ...
      <progress
        v-if="isLoading"
        class="progress is-small is-primary mt-6"
        max="100"
      ></progress>
    </div>
    <div class="column is-1"></div>
    <div class="column">
      <div v-if="notes.length == 0" class="title is-size-4">
        Notes are empty.
      </div>
      <div v-if="notes.length == 0" class="is-size-5">
        You can post something using the form.
      </div>
      <NoteCard
